...
export default class Component extends React.Component {
  ...
  _getparams = () => {
    ...
    const getCategory = params ? params.category : 'Junkfood';
    const getNama = params ? params.nama : 'Nama';
    const getPhoto = params ? params.photo : 'http://';
    const getDescription = params ? params.description : 'dasdasda';
    const getPrice = params ? params.price : 100;
  ...
  _onPressFav = () => {
    try {
      this.state.isFav ? this._delete(this.state.name) : this._searchById();
    } catch (error) {
      console.log(error);
    }
  };
  ...
  //       // data ini nantinya di rubah dengan props
  //       [this.state.nama, this.state.description, this.state.photo],
  //       (txn, result) => {
    ...
    <View style={styles.container}>
      <View style={styles.contentDetail}>
        ...
        <View style={styles.numDetail}>
          <Text style={styles.txtNum}>{this.state.price}</Text>
        </View>
      </View>
